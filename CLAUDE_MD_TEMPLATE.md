...
**Name:** [Your Replit App Name]
**URL:** https://[your-app].replit.app
**Tech Stack:** [e.g., Node.js, Express, React, etc.]
...
- Components in `/components` (if React/frontend)
...
**Critical User Flows:** [Customize these for your app]
- [Flow 1: e.g., User creates account]
- [Flow 2: e.g., User submits form]
- [Flow 3: e.g., Admin manages content]
...
- Always test changes before saying they're complete
- Provide screenshot URLs for visual verification
- Report performance metrics for every page load
- Check for console errors and network failures
- Test like a real user would interact with the app

## Questions?

If unsure about testing approach, read `.claude/TESTING_GUIDE.md` for comprehensive examples and patterns.
